        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="bg-white rounded-2xl testimonial-card-shadow p-8 flex flex-col items-center text-center">
              ...
              <p className="text-sm text-gray-600">
                Валютные пары и криптовалюты для Call/Put сделок.
              </p>
            </div>
            <div className="bg-white rounded-2xl testimonial-card-shadow p-8 flex flex-col items-center text-center">
              <p className="text-4xl md:text-5xl font-bold text-gray-900 mb-2">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Мы создали платформу, чтобы каждый мог удобно и комфортно получить доступ к торговле на валютном рынке. Простой интерфейс, понятные условия и поддержка на каждом шаге — всё для того, чтобы начать торговать мог даже новичок. Демо-счёт для практики, реальный счёт для заработка, профессиональные графики и быстрый вывод средств. Наша цель — сделать торговлю доступной и прозрачной для всех.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="w-16 h-16 bg-[#3347ff]/10 rounded-xl flex items-center justify-center mb-4">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Честные условия сделок, фиксированная доходность до 89%. Без скрытых комиссий.
                </p>
              </div>
