    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-24 bg-[#061230] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 pt-8 pb-16 md:pt-12 md:pb-24">
          <nav className="flex items-center gap-2 text-sm text-gray-400 mb-6" aria-label="Хлебные крошки">
            ...
            <span className="text-white">Активы</span>
          </nav>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4">Активы</h1>
          <p className="text-lg text-gray-400 max-w-2xl">
            Валютные пары, криптовалюта, индексы и другие инструменты для торговли на платформе COMFORTRADE.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 text-center mb-4">Активы</h2>
          <p className="text-base md:text-lg text-gray-600 text-center max-w-2xl mx-auto mb-12">
            Валютные пары, криптовалюта и другие инструменты для торговли. Выберите актив и узнайте подробнее.
          </p>
              ...
              <table className="w-full min-w-[1000px]">
                <thead>
                  <tr className="border-b border-gray-200">
                    <th className="text-left py-4 px-4 md:px-6 font-semibold text-gray-800">Имя</th>
                    <th className="text-left py-4 px-4 md:px-6 font-semibold text-gray-800">Цена</th>
                    <th className="text-left py-4 px-4 md:px-6 font-semibold text-gray-800">Объём</th>
                    <th className="text-left py-4 px-4 md:px-6 font-semibold text-gray-800">Доходность</th>
                    <th className="text-left py-4 px-4 md:px-6 font-semibold text-gray-800">Время работы</th>
                    <th className="text-left py-4 px-4 md:px-6 font-semibold text-gray-800">Действие</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    ...
                    <tr key={t.ticker} className="border-b border-gray-200 last:border-b-0">
                      ...
                      <td className="py-4 px-4 md:px-6 text-gray-900">{t.volume}</td>
                      <td className="py-4 px-4 md:px-6">
