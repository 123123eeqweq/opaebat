    ...
    >
      <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-6 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 flex-1 justify-center">
          {navLink('/start', 'Как начать?', 'start')}
          {navLink('/assets', 'Активы', 'assets')}
          {navLink('/about', 'О компании', 'about')}
          {navLink('/reviews', 'Отзывы', 'reviews')}
          {navLink('/education', 'Обучение', 'education')}
        </nav>
